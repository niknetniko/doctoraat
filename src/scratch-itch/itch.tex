...
\begin{itemize}
    \item Exercises (especially in Scratch) that were not created with testability in mind are often hard, if not impossible, to properly test without resorting to static analysis of the code.
