...
We also discuss our experiences using Itch in educational practice.
...
We therefore explore a prototype of a testing framework that allows writing test suites in Scratch itself.
