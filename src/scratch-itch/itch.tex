...
Porviding insights from this data to educators is one area of future work that is planned by CodeCosmos.
...
In Itch, this kind of automated assessment is made possible by the static tests in the before execution phase of the test suite.
