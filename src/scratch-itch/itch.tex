...
Most of the options are self-explanatory, but the output format option is explained in \cref{sec:format-of-the-generated-feedback}.
...
\marginnote{A headless browser means a full browser but without user interface.}
