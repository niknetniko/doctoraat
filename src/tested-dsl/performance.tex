...
\begin{tikzpicture}
    \begin{axis}[
        ...
        \addplot[fill=ugent-we] coordinates {
            (150,2)
            (250,10)
            (350,12)
            (450,12)
    ...
    \begin{axis}[
        ...
        \addplot [boxplot prepared={
            ...
            box extend=0.5
        },draw=black,fill=ugent-we] coordinates {(0,1319.759644) (0,1356.797906) (0,1369.516804) (0,1388.407927) (0,1482.881139) (0,2206.955292)};
    \end{axis}
\end{tikzpicture}
