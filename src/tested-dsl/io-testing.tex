...
\begin{tikzpicture}[x=0.75cm,y=0.75cm,fill fraction/.style={path picture={
  ...
  \node[executable,label={[fieldset,fill fraction=gray!30,above left=-0.54\block and -1.2\block]submission},minimum width=4\block,minimum height=1.5\block] at (3.75, 0) (subm) {};
