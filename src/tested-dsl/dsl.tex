   ...
   cases:
     - script:
         ...
         - expression: "cipher01.decode('BCCDBACA')"
           exception: 'invalid message'
     - script:
         # statements and expressions of the second script
    \end{minted}
    \caption[]{
...
Separating validation of the two functions across two separate units allows students to immediately pinpoint what functions already behave as expected from the feedback.
