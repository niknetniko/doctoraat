...
The Lifelong Kindergarten group at MIT has played a crucial role in this area by developing Scratch~\autocite{maloneyScratchProgrammingLanguage2010a}, a widely used programming language designed to teach programming to children aged 8 to 16.
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{scratch-normal-ide}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{scratch-debugger-ide}
    \caption{
...
This method subsequently creates threads (1), destroys threads (2) and calls \texttt{stepThreads} (3) as shown in \vref{fig:blink-architecture}.
...
\begin{figure}
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=0.6\linewidth]{likert1}
    \end{subfigure}
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=0.6\linewidth]{likert2}
    \end{subfigure}
