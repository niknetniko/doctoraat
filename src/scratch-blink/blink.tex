...
%Blocks can be dragged from the toolbox on the left side of the integrated development environment (IDE, \cref{fig:scratch}) to the workspace in the middle and can be stacked together to form scripts.
...
%When rewatching the execution of a program, changing the code will not affect the saved snapshots, although some children thought this was the case.
