...
The first research question \requ{1} was inspired by the observation that using exercises and judges in Dodona required some manual work.
...
With a working prototype at hand, the second research question \requ{2} came rather naturally.
...
Our JavaScript implementation of an analysis tool for Scratch 3.0\footnote{\url{https://github.com/scratch-ed/scratch-analysis}} (similar to Hairball~\autocite{boeHairballLintinspiredStatic2013}) is available under the MIT Licence.
