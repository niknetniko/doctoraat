...
This was initially done (since 2011) using the Sphere Online Judge (SPOJ; \cite{kosowskiApplicationOnlineJudge2008}), which was relatively unique in that it allowed teachers to create their own courses, exercises, and even testing frameworks.
...
\Cref{ch:itch} addresses research question three, while \cref{ch:blink,ch:scratch-execution-model} address the fourth research question.
...
However, to use an exercise in another programming language, first a copy of the exercise had to be made.
