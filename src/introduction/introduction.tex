...
Based on our preliminary exploration, our proposed changes do not cause major problems for existing Scratch projects, while still being an improvement for debuggers.
While we believe these changes to be promising, they must still be verified in educational practice and in a classroom setting to ensure that the changes are intuitive and do not have adverse effects.
