...
\begin{bookcover}
    ...
    \begin{bookcoverelement}{normal}{back}[15mm,15mm,15mm,15mm]
        \fontsize{12pt}{17pt}\selectfont{}\setlength{\parskip}{0.1cm}
        ...
        Overall, this dissertations remedies some shortcomings in existing educational tools, aiming to enhance the learning and teaching of programming.
        \vspace*{\fill}%
        \begin{center}%
