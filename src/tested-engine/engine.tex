...
All test suites rely only on the built-in checks of TESTed, so for the Advent of Code challenges we never had to rely on the programmed checks or language-specific checks.
