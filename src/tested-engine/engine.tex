...
A programming exercise is the combination of a \textbf{task description} and a \textbf{test suite}.
When students attempt to solve the exercise using the instructions from the task description, they create a \textbf{submission} for the exercise.
...
We consider it useful to split a judge system into a \textbf{judge platform} and a \textbf{testing framework}.
...
Intuitively, an ideal testing framework that supports multiple programming languages is a testing framework with the testing capabilities of unit testing and the programming language support of output comparison.
...
The \textbf{first requirement} is that test suites must be programming language agnostic.
