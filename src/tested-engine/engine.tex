 ...
 "output": {
  "result": {
   "value": {
    ...
    \captionof{figure}{
        \textit{(right)} A way to visually render the feedback (as done in Dodona) resulting from evaluating a submission (in Python) with the test suite from the left.
...
\begin{listing}
    \begin{wide}
        % Hardcoded margin...
        \begin{minted}[xleftmargin=\evensidemargin]{json}
