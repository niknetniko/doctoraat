...
%    \draw[step=1,gray!30,thin] (0,0) grid (11,-20);
    ...
    \node[contt,compop,minimum width=4.5\block] at (6.5,-5.25) (cu2) {Compilation unit $m$};
    ...
    \node[document,minimum width=4.5\block,minimum height=1\block] at (6.5,-7.75) (tc3) {Test code $m$};
    ...
    \node[box,minimum width=4.5\block,height=1] at (6.5,-9.25) (comp2) {Compilation $m$};
    ...
    \node[box,execop,minimum width=2.5\block,height] at (8.25,-11.25) (e3) {E\textsubscript{$k$}};
    ...
    \node[document,minimum width=2.5\block,minimum height=1\block] at (8.25,-14.25) (res3) {Result $n$};
