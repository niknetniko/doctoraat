...
%    \draw[step=1.0,gray,thin] (0,0) grid (6,-16);
    ...
    \node[box,hnode,minimum width=4\block,minimum height=1.5\block] at (3.5, -3) (scratch-render-fonts) {\footnotesize\texttt{scratch-render-} \\ \footnotesize\texttt{fonts}};
    ...
    \node[box,hnode,minimum width=4\block,minimum height=1.5\block] at (-3.5, -6) (scratch-sb1) {\footnotesize\texttt{scratch-sb1-} \\ \footnotesize\texttt{converter}};
    ...
    \node[box,hnode,minimum width=4\block,minimum height=1.5\block] at (0, -9) (scratch-svg-render) {\footnotesize\texttt{scratch-svg-} \\ \footnotesize\texttt{render}};
