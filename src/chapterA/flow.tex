...
\tikzstyle{document}=[node,tape,tape bend top=none,anchor=north west]
\tikzstyle{box}=[draw,rectangle,anchor=north west]
\tikzstyle{cont}=[box,height,minimum width=1\unit]
...
%    \draw[step=1,gray!30,thin] (0,0) grid (11,-20);
    ...
    \node[cont] at (1.25, -1.25) (c1) {C\textsubscript{1}};
    \node[cont] at (2.5, -1.25) (c2) {C\textsubscript{2}};
    \node[cont,draw opacity=0] at (3.5, -1.25) (c2) {\ldots};
    \node[cont] at (4.5, -1.25) (c3) {C\textsubscript{$n$}};
    ...
    \node[cont,comp,minimum width=4.5\unit] at (0,-5.25) (cu1) {Compilation unit 1};
    \node[cont,draw opacity=0] at (5, -5.25) {\ldots};
    \node[cont,comp,minimum width=4.5\unit] at (6.5,-5.25) (cu2) {Compilation unit $m$};
    ...
    \node[cont,draw opacity=0] at (5, -7.75) {\ldots};
    ...
    \node[cont,draw opacity=0] at (6.75, -11.25) {\ldots};
