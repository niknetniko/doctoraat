...
\begin{tikzpicture}[x=0.75cm,y=0.75cm]
    ...
    \begin{scope} [shift={(0,0.625)}]
        ...
        \node[exec,minimum height=2.25\unit,minimum width=4.25\unit] at (0.625,-0.875) (exec1) {};
        \node[exec,minimum height=2.25\unit,minimum width=1.25\unit] at (5.375,-0.875) (exec2) {};
        \node[exec,minimum height=2.25\unit,minimum width=6\unit] at (6.875,-0.875) (exec3) {};
    \end{scope}
    ...
    \begin{scope} [shift={(0,-2.75)}]
        \begin{scope} [shift={(0,0.625)}]
            ...
            \node[exec,minimum height=2.25\unit,minimum width=4.25\unit] at (0.625,-0.875) (exec1) {};
            \node[exec,minimum height=2.25\unit,minimum width=1.25\unit] at (5.375,-0.875) (exec2) {};
            \node[exec,minimum height=2.25\unit,minimum width=1.25\unit] at (6.875,-0.875) (exec3) {};
            \node[exec,minimum height=2.25\unit,minimum width=4.25\unit] at (8.625,-0.875) (exec3) {};
        \end{scope}
    \end{scope}
\end{tikzpicture}
