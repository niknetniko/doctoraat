...
% Define a toggle for the print version.
% In the print version, there are no coloured refs and black and white code highlighting.
\newtoggle{print}

% Define the toggle to be true or false.
%\toggletrue{print}
\togglefalse{print}
...
\iftoggle{print}{%
    % Set code highlighting to black and white.
    \setminted{style=bw}
}{}
...
\subfile{colophon.tex}

\subfile{summary-nl.tex}
\subfile{summary-en.tex}

\subfile{dankwoord.tex}
