...
% Taalinstellingen.
\definecolor{input-green}{rgb}{0.32941,0.5098,0.20784}
\definecolor{output-blue}{rgb}{0.18039,0.45882,0.71373}
...
%This part of the thesis concerns TESTed, an educational testing framework that enables creating programming-language-agnostic programming exercises.
%The first chapter (TODO) is an almost identical copy of TODO.
%It discusses TESTed-DSL, our system for creating test suites.
%
%The second chapter discusses TESTed itself.
%This is based largely on TODO, but with significant changes.
%For example, some parts are greatly expanded.
%
%The reader might note that source for the first chapter is newer than the second chapter.
