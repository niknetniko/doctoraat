...
\usepackage{scratch3}
%! parser = off
% Extend Scratch3 with blocks for the debugger.
\catcode`\_11
...
\title{De Instrumentis Docendae Programmaturae Computatralis}
\subtitle{On the Instruments of Teaching Computer Programming}
