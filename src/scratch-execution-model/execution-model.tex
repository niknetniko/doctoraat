...
For the complexity, they utilise the cyclomatic complexity metric~\autocite{mccabeComplexityMeasure1976}.
...
Here, we look at the use of blocks in Scratch projects.
...
Scratch blocks can be categorised into seven types, based on their shape (\cref{sec:elements-of-a-scratch-program}).
\Cref{fig:block-shapes} shows their usage, with a total of \num{47808628} blocks.
...
The number of projects that use a block from a certain category are shown in \cref{fig:block-categories}.
